...
- I have tried using multithreading to improve performance, but without success (there are limitations from the library and my lack of knowledge at the time of development). I will consider revisiting this to integrate GPU computation support and multithreading (if I find a use for it that works).
